...
# Fishing rates
juvenile_fishing_rate <- 0.1    # Fraction of juvenile population caught by fishing per time step
adult_fishing_rate <- 0.2       # Fraction of adult population caught by fishing per time step
