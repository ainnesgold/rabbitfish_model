...
# Plot the results
plot(1:time_steps, juvenile_population_over_time, type = "o", col = "blue", ylim = c(0, max(juvenile_population_over_time, subadult_population_over_time, adult_population_over_time)), xlab = "Time", ylab = "Population Size", main = "Stage-Structured Fish Population Model")
